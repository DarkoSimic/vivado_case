...
HD_PWD='C:/Users/Darko/Documents/Vivado/Examples/case_loop/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log case_loop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source case_loop.tcl
